...
class BurpExtender(IBurpExtender, IScannerCheck):
    ...
    def doPassiveScan(self, baseRequestResponse):
        ...
        payloads = ["%2e/"+LastPath, LastPath+"/.", "./"+LastPath+"/./", LastPath+"%20/", "%20"+LastPath+"%20/", LastPath+"..;/",LastPath+"?",LastPath+"??","/"+LastPath+"//",LastPath+"/",LastPath+"/.randomstring",LastPath+"/.json",LastPath+"/.html"]
